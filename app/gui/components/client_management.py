...
def _render_general_settings():
    ...
    def _auto_save_general_settings():
        ...
        # Telegram token/chat - сохранить старые если отключен
        _final_token = _tg_token if _tg_enabled else _notif.get('telegram_bot_token', '')
        _final_chat = _tg_chat if _tg_enabled else _notif.get('telegram_chat_id', '')
