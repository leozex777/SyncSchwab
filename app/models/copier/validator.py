...
class OrderValidator:
    ...
    def __init__(self, config: dict = None):
        ...
        self.MAX_ORDER_SIZE = config.get('max_order_size', limits['max_order_size']) \
            if config else limits['max_order_size']
        self.MAX_POSITION_VALUE = config.get('max_position_value', limits['max_position_value']) \
            if config else limits['max_position_value']
        self.MIN_ORDER_VALUE = config.get('min_order_value', limits['min_order_value']) \
            if config else limits['min_order_value']
        self.MAX_ORDERS_PER_RUN = config.get('max_orders_per_run', limits['max_orders_per_run']) \
            if config else limits['max_orders_per_run']
